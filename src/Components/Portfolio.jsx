...
const portfolioProjects = [
  ...
  },
  {
    ...
    caseStudy: {
      challenge: "Our brand needs a site that reflects authority, speed, and conversion mastery.",
      solution:
...
const Portfolio = () => {
  ...
  return (
    <section
      id="portfolio"
      className="bg-gradient-to-r from-purple-950 via-blue-900 to-yellow-800 text-white py-20 px-6 lg:px-10"
    >
      <div className="max-w-7xl mx-auto">
        ...
        <header className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-gray-100 text-lg max-w-2xl mx-auto">
            Discover professional Springfield Missouri web design projects — built for speed, SEO, and small business success.
          </p>
        </header>
        ...
        >
          ...
          <figcaption className="bg-purple-950/80 mt-8 p-6 lg:p-8 rounded-lg shadow-xl max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 mb-1">
              Our team transforms a dated medical site into a sleek, HIPAA-compliant lead-generation machine.
            </p>
              ...
              <>
                ...
                <section className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600">{selected.caseStudy.challenge}</p>
                  </div>
                  <div>
                    <h4 className="text-lg font-semibold text-gray-800">Solution</h4>
                    <p className="text-gray-600">{selected.caseStudy.solution}</p>
                  </div>
                  <div>
        ...
        <footer className="mt-16 text-center">
          <a
            href="#contact"
            className="inline-block bg-yellow-400 hover:bg-yellow-300 text-purple-900 font-bold px-8 py-4 rounded-full transition focus:outline-none focus:ring-4 focus:ring-yellow-500 shadow-lg"
          >
