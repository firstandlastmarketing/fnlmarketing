...
const PostDetail = () => {
  ...
  const shareUrl = `https://firstandlastmarketing.com/blog/${post.slug}`;
  ...
  return (
    ...
    <Helmet>
      ...
      `}</script>
    </Helmet><div className="bg-white min-h-screen text-gray-900">
        <BlogNavBar />
        ...
        <div className="max-w-4xl mx-auto px-6 pt-24 sm:pt-28 pb-12">
          ...
          <div className="space-y-2 sm:space-y-4 mb-6 text-center">
            ...
            <p className="text-sm sm:text-base text-gray-600 max-w-2xl mx-auto">{post.summary}</p>
          ...
          <div className="mt-12 border-t pt-8 flex flex-col sm:flex-row justify-between gap-4 text-sm">
            {prevPost ? (
              <Link
                ...
                className="flex items-center gap-2 text-indigo-700 hover:text-indigo-900 transition font-medium"
              >
            ...
            {nextPost ? (
              <Link
                ...
                className="flex items-center justify-end gap-2 text-indigo-700 hover:text-indigo-900 transition font-medium ml-auto"
              >
