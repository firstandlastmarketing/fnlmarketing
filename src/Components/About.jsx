...
import { FaAward, FaHeart, FaGlobe, FaServer, FaChartLine, FaComments, FaRobot, FaBolt } from 'react-icons/fa';
import aboutImage from '../assets/aboutImage.png';

const About = () => {
  const stats = [
    { value: "10+", label: "Years of Experience", icon: <FaAward className="text-purple-600" /> },
    { value: "50+", label: "Happy Clients", icon: <FaHeart className="text-purple-600" /> },
    { value: "100+", label: "Websites Built", icon: <FaGlobe className="text-purple-600" /> },
    { value: "99.9%", label: "Hosting Uptime", icon: <FaServer className="text-purple-600" /> },
  ];
  ...
  return (
    <section id="about" className="py-20 bg-gradient-to-br from-blue-50 to-purple-100" aria-labelledby="about-title">
      <div className="container mx-auto px-4">
        <article className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="lg:w-7/12">
            <header className="mb-6">
              <h2 id="about-title" className="text-4xl font-bold text-gray-800 mb-4">
                About <span className="text-purple-600">First and Last Marketing</span>
              </h2>
              <p className="text-lg text-gray-600">
                We're a full-service digital agency helping local and national businesses generate leads, boost conversions, and dominate their niche online.
                Our expert team blends <strong>web design, automation, AI tools, and SEO</strong> to deliver consistent results that matter.
              </p>
            </header>

            {/* Key Services */}
            <section aria-label="What We Offer" className="mb-8">
              <h3 className="text-xl font-semibold text-gray-800 mb-4">What Sets Us Apart</h3>
            ...
            {/* Stats Section */}
            <section className="grid grid-cols-2 gap-4 mb-8" aria-label="Company Stats">
        ...
        >
          ...
          <div className="relative z-10">
            <h3 id="mission-heading" className="text-2xl font-bold text-gray-800 mb-6">
              Our Mission
            </h3>
